...
def run_tno_benchmark() -> None:
    device = "cuda" if torch.cuda.is_available() else "cpu"
    _clip, _ = clip_backend.load("ViT-B/32", device=device)

    cap_embeds_path = "../embeddings/caption_test/caption_embeddings_test_TNO.pt"
    visual_embeds_path = "../embeddings/visual_test/visual_embedding_test_TNO.pt"
